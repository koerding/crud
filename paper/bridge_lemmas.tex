...
(ii) The output is sensitive to both $p_X$ and $p_Y$. Doubling $p_Y$ at fixed RR can change $r$ by a factor of $\sqrt{2}$ or more; halving $p_X$ from $0.5$ to $0.05$ at fixed RR$=1.5$ changes $r$ from $0.10$ to $0.04$. Table~\ref{tab:rr-to-r} therefore fixes one prevalence pair; reading other rows in the empirical literature requires recomputing with that domain's prevalences.
