...
\paragraph{Datasets.} Nine large public datasets spanning population health, neuroscience, genomics, psychology, political science, and vision (Section~\ref{sec:datasets-main}; SI Appendix~\ref{si:datasets} gives provenance and dimensions): NHANES, precinct voting + Census, GTEx v8, Allen Institute mouse RNA-seq, HEXACO, CIFAR-10, Kay fMRI, Haxby fMRI, and Stringer mouse V1.
