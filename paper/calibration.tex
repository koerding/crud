...
\paragraph{Distinction from multiple testing.} Unlike multiple-testing corrections, which assume a sharp null of zero effect, the crud-aware test calibrates against a background of real nonzero dependencies induced by latent structure. It controls Type-I error under a domain-calibrated null---the hypothesis that the target pair's association is typical of the background---rather than under the classical null of zero effect.
